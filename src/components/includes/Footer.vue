<template>
  <v-footer padless>
    <v-row justify="center" no-gutters>
      ...
      <v-btn color="white" text class="my-2" to="//paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=LUBJ846KR6SKS&source=url" target="_blank" rel="noreferrer">Donate</v-btn>
    </v-row>
  </v-footer>
</template>
