  ...
  <v-container>
    ...
    <section>
      ...
      <div>
        <p>
          ...
          you, whether personally or on behalf of an entity (“you”) and Floob
          ("Company", “we”, “us”, or “our”), concerning your access to and use
          of the https://floob.gg website as well as any other media form, media
    ...
    <section>
      ...
      <div>
        <p>
          ...
          any applicable law or regulation.(9) creating a Floob room, posting
          content in a Floob room, or participating in a Floob room means your
          taking sole responsible for the content of, and any harm resulting
          from, that Content or your conduct. This will be the case regardless
          of what form the Content takes includes, but is not limited to text,
          photo, video, audio, or code. We are not responsible for information
          that you choose to share on Floob, or for the actions of other
          users.(10)Floob does not control or monitor the content in rooms. All
          content is provided and controlled by you.
        </p>
        <p>
      ...
      <div>
        ...
        <div class="body">
          ...
          <ul>
            ...
            <li>
              Harass, annoy, intimidate, or threaten any of our employees,users
            ...
            <li>Telling other people you will hurt or kill them.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section>
      ...
      <div>
        <p>
          ...
          Policy: put here . By using the Site, you agree to be bound by our
          Privacy Policy, which is incorporated into these Terms of Use. Please
          be advised the Site is hosted in the United States. If you access the
    ...
    <section>
      ...
      <div>
        ...
        <p class="subtitle-1">Binding Arbitration</p>
        <p>
          ...
          place in USA County, Florida. Except as otherwise provided herein, the
        ...
        <p>
          ...
          and federal courts located in USA County, Florida, and the Parties
        ...
        <p class="subtitle-1">Restrictions</p>
        <p>
