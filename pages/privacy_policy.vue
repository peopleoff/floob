<template>
  <v-container>
    ...
    <p>
      ...
      concerns about our policy, or our practices with regards to your personal
      information, please contact us at
      <a href="mailto:Support@floob.gg?subject=Privacy Policy Concern"
        >Support@Floob.gg</a
      >. When you visit our and use our services, you trust us with your
      ...
      agree with, please discontinue use of our and our services. This privacy
      policy applies to all information collected through our and/or any related
      services, sales, marketing or events (we refer to them collectively in
      this privacy policy as the "Services"). Please read this privacy policy
    ...
    <ol class="py-4">
      ...
      <li>
        <a href="#will_your_information_be_shared_with_anyone"
          >Will Your Information Be Shared With Anyone?</a
        >
      </li>
      <li>
        <a href="#do_we_use_cookies_and_other_tracking_technologies"
      ...
      <li>
        <a href="#what_is_our_stance_on_third-party_websites"
          >What Is Our Stance On Third-party Websites?</a
        >
      </li>
      <li>
        <a href="#how_long_do_we_keep_your_information"
      ...
      <li>
        <a href="#controls_for_do-not-track_features"
          >Controls For Do-not-track Features</a
        >
      </li>
      <li>
        <a href="#do_california_residents_have_specific_privacy_rights"
          >Do California Residents Have Specific Privacy Rights?</a
        >
      </li>
      <li>
        <a href="#do_we_make_updates_to_this_policy"
          >Do We Make Updates To This Policy?</a
        >
      </li>
      <li>
        <a href="#how_can_you_contact_us_about_this_policy"
    ...
    <section id="what_information_do_we_collect">
      ...
      <div>
        ...
        <p class="subtitle-1 font-weight-light font-italic">
          <span class="in-short"> In Short: </span> We collect personal
        ...
        <p>
          ...
          when registering at the expressing an interest in obtaining
          information about us or our products and services, when participating
          in activities on the (such as posting messages in our online forums or
        ...
        <p>
          ...
          or navigate Floob. This information does not reveal your specific
        ...
        <div class="body">
          ...
          <ul>
            <li>
              ...
              site, which will enable them to collect data about how you
              interact with the over time. This information may be used to,
            ...
            <li>
              ...
              interact with public areas of the site , such personal information
              ...
              register through a social network (such as Facebook), your
    ...
    <section id="is_your_information_transferred_internationally">
      ...
      <div>
        ...
        <p>
          Our servers are located in USA. If you are accessing our from outside,
    ...
    <section id="what_is_our_stance_on_third">
      ...
      <div>
        <p class="subtitle-1 font-weight-light font-italic">
          ...
          the safety of any information that you share with third-party
          providers who advertise, but are not affiliated with, our websites.
        </p>
        <p>
          The may contain advertisements from third parties that are not
          ...
          applications that may be linked to or from the . You should review the
    ...
    <section id="do_we_collect_information_from_minors">
      ...
      <div>
        ...
        <p>
          ...
          at
          <a
            href="mailto:Support@floob.gg?subject=Do We Collect Information From Minors Concern"
            >Support@Floob.gg</a
          >
        </p>
      </div>
    ...
    <section id="what_are_your_privacy_rights">
      ...
      <div>
        ...
        <p>
          ...
          <a
            href="mailto:Support@floob.gg?subject=What Are Your Privacy Rights Concern"
            >Support@Floob.gg</a
          >
          <br />
    ...
    <section id="how_can_you_contact_us_about_this_policy">
      ...
      <div>
        <p>
          ...
          at
          <a
            href="mailto:Support@floob.gg?subject=How Can You Contact Us About This Policy Concern"
            >Support@Floob.gg</a
          >
        </p>
        <p>
        ...
        <p>
          ...
          by email Support@floob.gg. We will respond to your request within 60
          days.
        </p>
      </div>
    </section>
