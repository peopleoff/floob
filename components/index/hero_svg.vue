...
function initialState() {
  return {
    gifs: [
      //Antonios Gifs
      "https://media.giphy.com/media/8hXXive0XAhn7ccHII/giphy.mp4",
      "https://media.giphy.com/media/14fX2WQuOIVHBC/giphy.mp4",
      "https://media.giphy.com/media/Ud2GqU4MOEW9a/giphy.mp4",
      "https://media.giphy.com/media/uB2szZH5JSIU0/giphy.mp4",
      "https://media.giphy.com/media/5siH3iqfuIi2s/giphy.mp4",
      "https://media.giphy.com/media/jluE44PLcQSli/giphy.mp4",
      "https://media.giphy.com/media/d3WdQEmCDfLsMErS/giphy.mp4",
      "https://media.giphy.com/media/tIZUToOMEFGM0/giphy.mp4",
      "https://media.giphy.com/media/5GUp79EEUZ6wg/giphy.mp4",
      "https://media.giphy.com/media/IBJ53vzfWwDuw/giphy.mp4",
      "https://media.giphy.com/media/lv5HSbHACdaO4/giphy.mp4",
      "https://media.giphy.com/media/1zJEz2pvqumDlG2Twh/giphy.mp4",
      "https://media.giphy.com/media/mvRwcoCJ9kGTS/giphy.mp4",
      // Ruslans Gifs
      "https://media.giphy.com/media/TPeGCbJjGLgxW/giphy.mp4",
      "https://media.giphy.com/media/cPfjwUZtwArxyHVqjz/giphy.mp4",
      "https://media.giphy.com/media/2CWIaWhMrphDy/giphy.mp4",
      "https://media.giphy.com/media/Y01jP8QeLOox2/giphy.mp4",
      "https://media.giphy.com/media/3o6ZtgrHwKzt6n0m52/giphy.mp4",
      "https://media.giphy.com/media/YoDRCRQktXD4AkJjnC/giphy.mp4",
...
#e91gzmp8e4he59 {
  animation: e91gzmp8e4he59_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he59_c_o {
  0% {
    opacity: 0;
  }
  6% {
...
#e91gzmp8e4he61 {
  animation: e91gzmp8e4he61_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he61_c_o {
  0% {
    opacity: 0;
  }
  7% {
...
#e91gzmp8e4he67 {
  animation: e91gzmp8e4he67_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he67_c_o {
  0% {
    opacity: 0;
  }
  22% {
...
#e91gzmp8e4he74 {
  animation: e91gzmp8e4he74_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he74_c_o {
  0% {
    opacity: 0;
  }
  18% {
...
#e91gzmp8e4he75 {
  animation: e91gzmp8e4he75_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he75_c_o {
  0% {
    opacity: 0;
  }
  25% {
...
#e91gzmp8e4he76 {
  animation: e91gzmp8e4he76_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he76_c_o {
  0% {
    opacity: 0;
  }
  23% {
...
#e91gzmp8e4he77 {
  animation: e91gzmp8e4he77_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he77_c_o {
  0% {
    opacity: 0;
  }
  21% {
...
#e91gzmp8e4he85 {
  animation: e91gzmp8e4he85_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he85_c_o {
  0% {
    opacity: 0;
  }
  28% {
...
#e91gzmp8e4he109 {
  animation: e91gzmp8e4he109_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he109_c_o {
  0% {
    opacity: 1;
  }
  29% {
...
#e91gzmp8e4he110 {
  animation: e91gzmp8e4he110_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he110_c_o {
  0% {
    opacity: 0;
  }
  18% {
...
#e91gzmp8e4he111 {
  animation: e91gzmp8e4he111_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he111_c_o {
  0% {
    opacity: 0;
  }
  14% {
...
#e91gzmp8e4he112 {
  animation: e91gzmp8e4he112_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he112_c_o {
  0% {
    opacity: 0;
  }
  17% {
...
#e91gzmp8e4he113 {
  animation: e91gzmp8e4he113_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he113_c_o {
  0% {
    opacity: 0;
  }
  13% {
...
#e91gzmp8e4he114 {
  animation: e91gzmp8e4he114_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he114_c_o {
  0% {
    opacity: 0;
  }
  12% {
...
#e91gzmp8e4he115 {
  animation: e91gzmp8e4he115_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he115_c_o {
  0% {
    opacity: 0;
  }
  16% {
...
#e91gzmp8e4he116 {
  animation: e91gzmp8e4he116_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he116_c_o {
  0% {
    opacity: 0;
  }
  15% {
...
#e91gzmp8e4he123_to {
  animation: e91gzmp8e4he123_to__to 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he123_to__to {
  0% {
    transform: translate(1098.401471px, 484.206113px);
  }
  2% {
    transform: translate(1098.401471px, 484.206113px);
  }
  9% {
    transform: translate(469.600094px, 187.011332px);
  }
  10% {
    transform: translate(471.420163px, 211.668555px);
  }
  21% {
    transform: translate(471.420163px, 211.668555px);
  }
  25% {
    transform: translate(937.734032px, 455.022995px);
  }
  32% {
    transform: translate(937.734032px, 455.022995px);
  }
  ...
  38% {
    transform: translate(1135.898434px, 788.266272px);
  }
  100% {
    transform: translate(1135.898434px, 788.266272px);
  }
...
#e91gzmp8e4he123 {
  animation: e91gzmp8e4he123_c_o 10000ms linear infinite normal forwards;
}
@keyframes e91gzmp8e4he123_c_o {
  0% {
    opacity: 0;
  }
  2% {
